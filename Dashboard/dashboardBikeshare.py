...
# load dataset
bike_sharing = pd.read_csv("https://raw.githubusercontent.com/andhikappratamaa/bikeSharingdataset_EDA/main/Dashboard/bike_sharing.csv")
...
with st.sidebar:
    ...
    st.image("https://raw.githubusercontent.com/andhikappratamaa/bikeSharingdataset_EDA/main/image/pngwing.com.png")
...
st.sidebar.header("Visit my Linkedin:")
st.sidebar.markdown("Andhika Putra Pratama")
st.sidebar.markdown("[![LinkedIn](https://content.linkedin.com/content/dam/me/business/en-us/amp/brand-site/v2/bg/LI-Bug.svg.original.svg)](https://www.linkedin.com/in/andhika-putra-pratama-712a84280//)")
# sidebar
...
# mainpage
st.title("Capital Bikeshare: Bike-Sharing Dashboard :bar_chart:")
st.markdown("##")
...
st.caption('Copyright ©, created by Andhika Putra Pratama')